...
public class APPMessage {
    ...
    private Map<String, Object> body = new HashMap<>();                 //消息body
    ...
    public String toJsonEncrypt() {
        ...
        String dataJson = JSONObject.toJSONStringWithDateFormat(dataMap, CommonConstants.PARTTERN_YYYY_MM_DD_HH_MM_SS);
        try {
        ...
        return JSONObject.toJSONStringWithDateFormat(map, CommonConstants.PARTTERN_YYYY_MM_DD_HH_MM_SS);
    }
