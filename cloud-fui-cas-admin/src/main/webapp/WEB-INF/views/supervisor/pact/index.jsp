...
<head>
    ...
    <link rel="shortcut icon" href="https://static.pgyer.com/static-20180608/assets/img/favicon.ico">
    <link rel="stylesheet" href="${pageContext.request.contextPath}/public/css/header_include_center.min.css">
    <link href="${pageContext.request.contextPath}/public/css/Roboto.css" rel="stylesheet" type="text/css">
    <link href="${pageContext.request.contextPath}/public/css/Open-Sans.css" rel="stylesheet" type="text/css">
    <%
...
<div class="page-topbar">
    <a href="https://www.pgyer.com/" target="_blank">
        <div class="logo-area">
        </div>
    </a>
    <div class="quick-area">
        <div class="pull-left">
            <ul class="info-menu left-links list-inline list-unstyled">
                ...
                <li class="sidebar-toggle-publish">
                    <div class="btn-group">
                        <a href="https://www.pgyer.com/app/publish" class="btn btn-default btn-publish">发布应用</a>
                        <button type="button" class="btn btn-default dropdown-toggle btn-publish" data-toggle="dropdown" aria-expanded="true">
                            <span class="caret"></span>
                        </button>
                        <ul class="dropdown-menu add-new-app" role="menu">
                            <li><a href="https://www.pgyer.com/app/add">添加空白应用</a></li>
                        </ul>
                    </div>
                </li>
            </ul>
        ...
        <div class="pull-right">
            <ul class="info-menu right-links list-inline list-unstyled">
                <li class="notify-toggle-wrapper showopacity">
                    <a href="https://www.pgyer.com/my#" data-toggle="dropdown" class="toggle" id="dropdown-button">
                        <i class="fa fa-bell"></i>
                        <span class="badge badge-accent hide" id="notificationCount">0</span>
                    </a>
                    <div class="dropdown-menu notification-dropdown-alert dropdown-alert" onclick="event.stopPropagation();" id="dropdown">
                        <div class="notification-dropdown-header text-center">
                            <span>通知</span>
                        </div>
                        <div class="slimScrollDiv" style="position: relative; overflow: hidden; width: auto; height: 350px;"><div class="notification-list" id="notifyContent2" style="overflow: hidden; width: auto; height: 350px;"><div style="text-align:center;margin-top:120px;"><h4 class="notification-empty-title">当前没有通知</h4><p class="notification-empty-text">查看所有通知中可以查看历史通知</p></div></div><div class="slimScrollBar" style="background: rgb(0, 0, 0); width: 7px; position: absolute; top: 0px; opacity: 0.4; display: block; border-radius: 7px; z-index: 99; right: 1px;"></div><div class="slimScrollRail" style="width: 7px; height: 100%; position: absolute; top: 0px; display: none; border-radius: 7px; background: rgb(51, 51, 51); opacity: 0.2; z-index: 90; right: 1px;"></div></div>
                        <a href="https://www.pgyer.com/notification" class="notification-link">查看所有通知</a>
                    </div>
                </li>

                <li class="question-toggle-wrapper">
                    <a href="https://www.pgyer.com/my#" data-toggle="dropdown" class="toggle"><i class="fa fa-question-circle" aria-hidden="true" style="font-size:16px;"></i></a>
                    <ul class="dropdown-menu profile">
                        <li><a href="http://kf.pgyer.com/ticket/add" target="_blank"><i class="fa fa-plus-circle"></i>提交工单</a></li>
                        <li><a href="http://kf.pgyer.com/" target="_blank"><i class="fa fa-file-text"></i>我的工单</a></li>
                        <li><a href="https://www.pgyer.com/doc" target="_blank"><i class="fa fa-life-ring"></i>帮助文档</a></li>
                    </ul>
                </li>
                <li class="profile showopacity">
                    <a href="https://www.pgyer.com/my#" data-toggle="dropdown" class="toggle">
                        <img src="${pageContext.request.contextPath}/public/images/profile.png" alt="user-image" class="img-circle img-inline">
                        <span class="user-icon"><img src="${pageContext.request.contextPath}/public/images/free.png"></span>
                        <span class="user-name">${user.cname}
                        <span class="user-certification"> (${user.ename})</span><i class="fa fa-angle-down" style="padding-left:5px;"></i></span>
                    </a>
                    <ul class="dropdown-menu profile">
                        <li><a href="https://www.pgyer.com/account/main"><i class="fa fa-cog"></i>账户设置</a></li>
    ...
    <div class="page-sidebar fixedscroll">
        ...
        <div class="page-sidebar-wrapper ps-container" id="main-menu-wrapper" style="height: 914px;">
            <ul class="wraplist" style="height: auto;">
                <li class="open menu-title">
                    <a href="https://www.pgyer.com/my">
                ...
                <li class=" menu-title">
                    <a href="https://www.pgyer.com/account/main">
                        <i class="fa fa-cog" aria-hidden="true"></i>
                        <span class="title ">账户设置</span>
                    </a>
                </li>

                <li class="menu-title searchform">
                    <hr class="search-top-hr">
                    <div class="input-group">
                    <span class="input-group-addon">
                        <i class="fa fa-search"></i>
                    </span>
                        <input type="text" id="keyword" oninput="showAppList()" onpropertychange="showAppList()" class="form-control input-search" placeholder="搜索您的应用">
                    </div>
                    <div class="filter-type dropdown">
                        <div class="dropdown-toggle" id="dropdownMenu1" data-toggle="dropdown">
                            <span id="app-type-icon"></span>
                        </div>
                        <ul class="dropdown-menu" role="menu" aria-labelledby="dropdownMenu1">
                            <li role="presentation">
                                <a role="menuitem" tabindex="-1" onclick="getListByType('all')"><span class="filter-ul-span"><i class="fa app-type-check fa-circle-check" id="all-check"></i><span>全部</span> <span class="app-count"><span>1</span></span></span></a>
                            </li>
                            <li role="presentation">
                                <a role="menuitem" tabindex="-1" onclick="getListByType('ios')"><span class="filter-ul-span"><i class="fa app-type-check" id="ios-check"></i><span>iOS</span> <span class="app-count"><span>0</span></span></span></a>
                            </li>
                            <li role="presentation">
                                <a role="menuitem" tabindex="-1" onclick="getListByType('android')"><span class="filter-ul-span"><i class="fa app-type-check" id="android-check"></i><span>Android</span> <span class="app-count"><span>1</span></span></span></a>
                            </li>
                        </ul>
                    </div>
                </li>
                ...
                <li class="menu-title">
                    <a href="https://www.pgyer.com/app/publish" style="color:#29cead;">
                        <i class="fa fa-plus-circle" aria-hidden="true" style="color:#29cead;"></i>
                        <span class="title">发布应用</span>
                    </a>
                </li>

                <div id="app-list">
                    <li class="menu-title sidebar-app ">
                        <a href="https://www.pgyer.com/manager/dashboard/app/be88ff033965d6cc3e23a69846f2fcc2" id="sideBarFirstApp">
                            <div class="app-icon">
                                <img src="${pageContext.request.contextPath}/public/images/60" class="appicon_sidebar pull-left img-circle" onerror="javascript:this.src='https://static.pgyer.com/static-20180608/assets/img/default-icon.png';" style="">
                            </div>
                            <div class="app-info">
                                <h4 class="app-title">玩耍的APP</h4>
                                <span class="app-type"> Android</span>
                            </div>
                        </a>
                    </li>
                </div>
...
<section id="main-content" class="">
    <section class="wrapper main-wrapper row" style="">
        ...
        <div class="col-xs-12">
            <div class="col-lg-3 col-xs-12 col-md-6 col-sm-12 greatest">
                <div class="row greatest-service">
                    <a href="https://www.duofan.com/" target="_blank">
                        <div class="col-lg-3 col-md-3 col-sm-3 col-xs-3 service-img">
                            <img src="${pageContext.request.contextPath}/public/images/033baab814dc0b2031b35f81720f8bfa" class="img-responsive center-block service-icon ">
                        </div>
                        <div class="col-lg-9 col-md-9 col-sm-9 col-xs-9 service-desc">
                            <p class="font-16 color-333 title">多返联盟</p>
                            <p class="font-14 color-878f92 pt-10 descript">互联网金融流量变现领先平台</p>
                        </div>
                    </a>
            ...
            <div class="col-lg-3 col-xs-12 col-md-6 col-sm-12 greatest">
                <div class="row greatest-service">
                    <a href="https://www.frontjs.com/" target="_blank">
                        <div class="col-lg-3 col-md-3 col-sm-3 col-xs-3 service-img">
                            <img src="${pageContext.request.contextPath}/public/images/c8a392fffd3a401c85ea59ebe34ca724" class="img-responsive center-block service-icon ">
                        </div>
                        <div class="col-lg-9 col-md-9 col-sm-9 col-xs-9 service-desc">
                            <p class="font-16 color-333 title">FrontJS</p>
                            <p class="font-14 color-878f92 pt-10 descript">全面、准确的网站错误监控平台</p>
                        </div>
                    </a>
                    <div class="border"></div>
                </div>
            ...
            <div class="col-lg-3 col-xs-12 col-md-6 col-sm-12 greatest">
                <div class="row greatest-service">
                    <a href="https://www.tracup.com/" target="_blank">
                        <div class="col-lg-3 col-md-3 col-sm-3 col-xs-3 service-img">
                            <img src="${pageContext.request.contextPath}/public/images/f32f9ffc6b31670f8774f96209223c5e" class="img-responsive center-block service-icon ">
                        </div>
                        <div class="col-lg-9 col-md-9 col-sm-9 col-xs-9 service-desc">
                            <p class="font-16 color-333 title">Tracup</p>
                            <p class="font-14 color-878f92 pt-10 descript">一款轻量级 Bug 追踪管理平台</p>
                        </div>
                    </a>
                    <div class="border"></div>
                </div>
            ...
            <div class="col-lg-3 col-xs-12 col-md-6 col-sm-12 greatest">
                <div class="row greatest-service">
                    <a href="https://www.pgyer.com/app/signature" target="_blank">
                        <div class="col-lg-3 col-md-3 col-sm-3 col-xs-3 service-img">
                            <img src="${pageContext.request.contextPath}/public/images/d33bffd940c000994b9d4446379c6b9a" class="img-responsive center-block service-icon ">
                        </div>
                        <div class="col-lg-9 col-md-9 col-sm-9 col-xs-9 service-desc">
                            <p class="font-16 color-333 title">iOS企业证书签名</p>
                            <p class="font-14 color-878f92 pt-10 descript">免提交审核，无需越狱即可安装</p>
                        </div>
                    </a>
                    <div class="border"></div>
                </div>
        ...
        <div class="col-lg-6 col-md-7 col-sm-12 col-xs-12 top-user-info">
            <section class="box ">
                <div class="content-body user-info-content">
                    <div class="row user-info-row user-account-info user-info-top">
                        <div class="col-xs-12 col-sm-8 col-md-8 col-lg-8">
                            <div class="profile-info row">
                                <div class="profile-image pull-left">
                                    <a href="https://www.pgyer.com/account">
                                        <img alt="" src="${pageContext.request.contextPath}/public/images/profile.png" class="img-responsive img-circle">
                                    </a>
                                </div>
                                <div class="profile-details pull-left">
                                    ...
                                    <p class="profile-title">
                                                                                <span class="user-icon user-icon-top">
                                            <img src="${pageContext.request.contextPath}/public/images/certification_success.png"> 已认证                                        </span>
                                        <span class="user-icon user-icon-top user-product-icon">
                                                <img src="${pageContext.request.contextPath}/public/images/free.png">
                                            </span>
                                        <span>基础版</span>
                                    </p>
                                </div>
                        ...
                        <div class="col-xs-12 col-sm-4 col-md-4 col-lg-4">
                            <div class="profile-info row">
                                <div class="profile-account pull-left">
                                    <span class="profile-account-text font-gray">
                                        账户余额                                    </span>
                                    <p class="profile-balance">
                                        0.00                                        <span class="balance-yuan font-gray">元</span>
                                        <a class="btn pull-right btn-primary btn-radius-4 btn-xs" href="https://www.pgyer.com/price/accountPay" style="margin-left: 15px;margin-top:3px;">
                                            <span class="align-sub">充值</span>
                                        </a>
                                    </p>
                                </div>
                            </div>
                    ...
                    <div class="row stat-row usage-percent user-info-bottom">
                        <div class="col-xs-12 col-md-4 col-lg-4 stat-item pl-10 pr-10">
                            <div class="col-xs-12 col-md-12 col-lg-12">
                                <span class="pull-left font-gray">今日下载次数</span>
                                <span class="pull-right stat-number">0/1000 </span>
                            </div>

                            <div class="col-xs-12 col-md-12 col-lg-12">
                                <div class="progress">
                                    <div class="progress-bar progress-bar-primary" role="progressbar" aria-valuenow="62" aria-valuemin="0" aria-valuemax="100" style="width: 0%"></div>
                                </div>
                            </div>
                        </div>
                        <div class="col-xs-12 col-md-4 col-lg-4 stat-item stat-item-middle">
                            <div class="col-xs-12 col-md-12 col-lg-12">
                                <span class="pull-left font-gray">今日短信用量</span>
                                <span class="pull-right stat-number">1/5</span>
                            </div>

                            <div class="col-xs-12 col-md-12 col-lg-12">
                                <div class="progress">
                                    <div class="progress-bar progress-bar-warning" role="progressbar" aria-valuenow="62" aria-valuemin="0" aria-valuemax="100" style="width: 20%"></div>
                                </div>
                            </div>
                        </div>
                        <div class="col-xs-12 col-md-4 col-lg-4 stat-item">
                            <div class="col-xs-12 col-md-12 col-lg-12">
                                <span class="pull-left font-gray">今日邮件用量</span>
                                <span class="pull-right stat-number">1/5</span>
                            </div>
                            <div class="col-xs-12 col-md-12 col-lg-12">
                                <div class="progress">
                                    <div class="progress-bar progress-bar-success" role="progressbar" aria-valuenow="62" aria-valuemin="0" aria-valuemax="100" style="width: 20%"></div>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <!-- USER INFO CARD SECTION START -->
        <div class="col-xs-12 col-lg-6 col-md-5 col-sm-12 user-info-card-section">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6">
                        <section class="box">
                            <div class="content-body user-info-card">
                                <div class="row visible-lg-custom">
                                    <div class="col-xs-3 col-md-3 col-lg-4 card-icon">
                                        <img src="${pageContext.request.contextPath}/public/images/notes.png">
                                    </div>
                                    <div class="col-xs-9 col-md-9 col-lg-8 card-content">
                                        <p class="user-info-card-title">基本信息</p>
                                        <p class="user-info-card-content font-gray">用户名、联系人、手机号、邮箱等</p>
                                        <span class="pull-right user-info-card-btn">
                                        <a href="https://www.pgyer.com/account/index" class="btn btn-xs btn-default btn-blank btn-radius-4">查看</a>
                                    </span>
                                    </div>
                                </div>

                                <div class="row hidden-lg-custom">
                                    <a href="https://www.pgyer.com/account/index">
                    ...
                    <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6">
                        <section class="box ">
                            <div class="content-body user-info-card">
                                <div class="row visible-lg-custom">
                                    <div class="col-xs-3 col-md-3 col-lg-4 card-icon">
                                        <img src="${pageContext.request.contextPath}/public/images/banknote.png">
                                    </div>
                                    <div class="col-xs-9 col-md-9 col-lg-8 card-content">
                                        <p class="user-info-card-title">财务信息</p>
                                        <p class="user-info-card-content font-gray">账户余额、充值提现、收支记录</p>
                                        <span class="pull-right user-info-card-btn">
                                        <a href="https://www.pgyer.com/account/transaction" class="btn btn-xs btn-default btn-blank btn-radius-4">查看</a>
                                    </span>
                                    </div>
                                </div>

                                <div class="row hidden-lg-custom">
                                    <a href="https://www.pgyer.com/account/transaction">
                                        <div class="user-card-top">
                                            <img src="${pageContext.request.contextPath}/public/images/banknote.png">
                                        </div>
                                        <div class="user-card-bottom">
                    ...
                    <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6">
                        <section class="box ">
                            <div class="content-body user-info-card">
                                <div class="row visible-lg-custom">
                                    <div class="col-xs-3 col-md-3 col-lg-4 card-icon">
                                        <img src="${pageContext.request.contextPath}/public/images/folder.png">
                                    </div>
                                    <div class="col-xs-9 col-md-9 col-lg-8 card-content">
                                        <p class="user-info-card-title">我的方案</p>
                                        <p class="user-info-card-content font-gray">价格方案、下载次数包</p>
                                        <span class="pull-right user-info-card-btn">
                                        <a href="https://www.pgyer.com/account/plan" class="btn btn-xs btn-default btn-blank btn-radius-4">查看</a>
                                    </span>
                                    </div>
                                </div>

                                <div class="row hidden-lg-custom">
                                    <a href="https://www.pgyer.com/account/plan">
                                        <div class="user-card-top">
                                            <img src="${pageContext.request.contextPath}/public/images/folder.png">
                                        </div>
                                        <div class="user-card-bottom">
                    ...
                    <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6">
                        <section class="box ">
                            <div class="content-body user-info-card">
                                <div class="row visible-lg-custom">
                                    <div class="col-xs-3 col-md-3 col-lg-4 card-icon">
                                        <img src="${pageContext.request.contextPath}/public/images/setting.png">
                                    </div>
                                    <div class="col-xs-9 col-md-9 col-lg-8 card-content">
                                        <p class="user-info-card-title">通知设置</p>
                                        <p class="user-info-card-content font-gray">手机短信、邮箱、微信通知</p>
                                        <span class="pull-right user-info-card-btn">
                                        <a href="https://www.pgyer.com/account/setting" class="btn btn-xs btn-default btn-blank btn-radius-4">修改</a>
                                    </span>
                                    </div>
                                </div>

                                <div class="row hidden-lg-custom">
                                    <a href="https://www.pgyer.com/account/setting">
                                        <div class="user-card-top">
                                            <img src="${pageContext.request.contextPath}/public/images/setting.png">
                                        </div>
                                        <div class="user-card-bottom">
        ...
        <div class="col-xs-12">
            <div class="page-title">
                <div class="pull-left">
                    <h1 class="title">常用应用</h1>
                </div>

                <span class="pull-right version-more"><a href="https://www.pgyer.com/mygroup" class="default">查看分组 (0) <i class="fa fa-angle-double-right"></i></a></span>
            </div>
        </div>
        <div class="clearfix"></div>
        ...
        <div class="col-lg-12">
            <section class="box ">
                <div class="content-body common-app-list">
                    <div class="container-fluid">
                        <div class="row">
                            <div class="table-responsive padding-top-45 padding-bottom-45">
                                <table class="table table-hover bg-white-only my-app-list">
                                    <thead>
                                    <tr style="font-weight: bold">
                                        <td style="width:20%">应用名称</td>
                                        <td style="width:20%">版本</td>
                                        <td class="hidden-md hidden-xs" style="width:15%">下载方式</td>
                                        <td style="width:20%">更新时间</td>
                                        <td style="width:10%" class="hide">今日下载</td>
                                    ...
                                    <tbody>
                                    <tr>
                                        <td class="v-middle app-td">
                                            <div class="app-icon">
                                        <span>
                                            <img src="${pageContext.request.contextPath}/public/images/60" class="appicon_list pull-left img-circle" onerror="javascript:this.src='https://static.pgyer.com/static-20180608/assets/img/default-icon.png';" style="">
                                        </span>
                                            </div>
                                            <div class="app-info">
                                                <h4 class="app-title">
                                                    玩耍的APP                                                                                </h4>
                                                <span class="app-type font-gray">
                                            Android                                        </span>
                                            </div>
                                        </td>
                                        <td class="v-middle">
                                    <span>
                                        ...
                                        <td class="v-middle hidden-md hidden-xs " nowrap="">
                                    <span>
                                        pgyer.com/YZW8
                                                                        <a href="javascript:void(0);" class="popovers" style="color:#9e9e9e" data-container="body" data-toggle="popover" data-trigger="hover" data-placement="top" data-content="&lt;img style=&quot;margin-top:0px;margin-bottom:14px;border-radius:0;border:none&quot; class=&quot;appicon&quot; src=&quot;https://static.pgyer.com/app/qrcode/YZW8&quot; /&gt;" data-original-title="扫描二维码下载" data-html="true" title="">
                                        ...
                                        <td class="v-middle">
                                    <span>
                                        2018-06-08 17:24                                    </span>
                                        </td>
                                        <td class="v-middle hide">
                                    <span>
                                        0                                        次                                    </span>
                                        </td>
                                        <td style="white-space: nowrap">
                                            <a href="https://www.pgyer.com/manager/dashboard/app/be88ff033965d6cc3e23a69846f2fcc2" class="btn btn-xs btn-default btn-blank btn-radius-4">
                                                <i class="fa fa-th-large" aria-hidden="true"></i> 应用详情                                    </a>
                                            <!-- form -->
                                            <a href="https://www.pgyer.com/YZW8" class="btn btn-xs btn-purple btn-radius-4" target="_blank"><i class="fa fa-eye" aria-hidden="true"></i> 查看</a>
                                            <a href="https://www.pgyer.com/my/appEdit/be88ff033965d6cc3e23a69846f2fcc2" class="btn btn-xs btn-info btn-radius-4"><i class="fa fa-edit" aria-hidden="true"></i> 编辑</a>
                                        </td>
    ...
    <!-- modal end -->
    <script async="" src="${pageContext.request.contextPath}/public/scripts/analytics.js"></script><script type="text/javascript">
    var userKey = "89c5706dbf42865a6abff15832b467dd";
    var noNotificationTitle = "当前没有通知";
    var noNotificationDescription = "查看所有通知中可以查看历史通知";
    var appNoSearchResult = "搜索...";
    var ticketUrl = "kf.pgyer.com";
    var appId = "";
</script>
    <!-- CORE JS FRAMEWORK - START -->
    <script type="text/javascript" src="${pageContext.request.contextPath}/public/scripts/userCenter.min.js"></script>
