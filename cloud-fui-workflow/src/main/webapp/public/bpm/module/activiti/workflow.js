$(function () {
    // 跟踪
    $("body").on("click", ".trace", graphTrace);
});
function graphTrace(options) {
    ...
    $('body').on('click', '#changeImg', function () {
        ...
        $('<div/>', {
            ...
            html: "<img src='" + fui.contextPath + '/supervisor/workflow/process/trace/auto/' + opts.pid + "' />"
    ...
    $('body').on('click', '#diagram-viewer', function () {
        ...
        var url = fui.contextPath + '/public/bpm/diagram-viewer/index.html?processDefinitionId=' + opts.pdid + '&processInstanceId=' + opts.pid;
    ...
    // 获取图片资源
    var imageUrl = fui.contextPath + "/supervisor/workflow/process/resource/process-instance?pid=" + opts.pid + "&type=image";
    $.getJSON(fui.contextPath + '/supervisor/workflow/process/trace?pid=' + opts.pid, function (infos) {
        var positionHtml = "";
        // 生成图片
