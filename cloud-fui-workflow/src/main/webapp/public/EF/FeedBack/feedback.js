(function (win, doc, undefined) {
    ...
    h2cAvailable,
    feedback_params={};//json 记录反馈 title,info
        ...
        init: function (options) {
            ...
            returnMethods = {
                ...
                open: function () {
                    ...
                    //录入用户反馈 title和 info
                    message = $("<textarea id='feedback_info' />")[0];
                    ...
                    if (win.html2canvas === undefined && script === undefined) {
                        ...
                        script.src = options.h2cPath || "./EF/FeedBack/html2canvas.min.js";
...
//                        button.parentNode.appendChild(script);
                    ...
                    nextButton.onclick = function () {
                        ...
                        //记录反馈title
						feedback_params.title=$('#feedback_info').val();
                    ...
                    function nextFunc() {
                        ...
                        if (h2cDone && clickDone) {
                            ...
                            blackoutButton = element("a", options.BlackButton||"Blackout"),
                            highlightButton = element("a", options.HighButton||"Highlight"),
                            previousElement;
                            ...
                            mouseMoveEvent = function (e) {
                                ...
                                if (e.target !== previousElement && ($(e.target).hasClass("feedback-blackedout") || $(e.target).hasClass("feedback-highlighted"))) {
                            ...
                            mouseClickEvent = function (e) {
                                ...
                                if (action === false) {
                                    if (blackoutBox.getAttribute(dataExclude) === "false") {
                                        ...
                                        $(blackout).addClass('feedback-blackedout');
                            ...
                            $(h2cCanvas).addClass('feedback-canvas');
                            ...
                            modalBody.appendChild(element("p", options.Highlight||"Highlight or blackout important information"));

                            // add highlight and blackout buttons
                            for (var i = 0; i < 2; i++) {
                                $(buttonItem[i]).addClass('btn');
                                $(buttonItem[i]).addClass('btn-small');
                                $(buttonItem[i]).addClass(i === 0 ? 'active' : 'btn-inverse');
...
//                    button.parentNode.appendChild(modal);
                ...
                review: function () {
                    ...
                    $(modal).addClass("feedback-animate-review");
                    ...
                    if (h2cCanvas !== undefined) {
                        ...
                        nextButton.firstChild.nodeValue = options.SendForm||"Send form";

                        $(h2cCanvas).addClass("feedback-canvas-complete");
                        ...
                        nextButton.onclick=function()
						{
							...
							feedback_params.info=$(message).val();

							//后台传输

							 var info = new EiInfo(); 
	  info.set('efFormEname',__eiInfo.get('efFormEname'));
	  info.set('title',feedback_params.title);
	  info.set('info',feedback_params.info);
	  info.set('data',Canvas2Image.scaleCanvas(h2cCanvas).toDataURL());
	  
	  EiCommunicator.send("EFFB00", "saveImageFile", info, null);
	  //EiCommunicator.send("EFFB00", "saveImageFile", info, null);
	  ...
	  returnMethods.close() ;
                    ...
                    $(browserSpecs).addClass("feedback-browser");
                    browserSpecs.appendChild(element("h3", options.browserInfo||"Browser information"));
           ...
           // glass.classList.add("feedback-glass"); HTML5 IE doesn't support
