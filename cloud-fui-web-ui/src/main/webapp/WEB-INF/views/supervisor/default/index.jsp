...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="${path}/webjars/fui/public/EP/indexReal-ModernBlack-3.0.css">
    ...
    <style type="text/css">
	    ...
	    .header{
	        background: url('${path}/webjars/fui/public/mainframe/images/header.gif') repeat-x 0 -1px;
	    }
        #menu .ef-tree-item-node>div.ui-theme>.ui-icon{
            background-image: url('${path}/webjars/fui/public/EF/Themes/base/images/ui-icons_222222_256x240.png');
        }
        .ui-widget-content .ui-icon{
            background-image: url('${path}/webjars/fui/public/EF/Themes/styleApple/ModernBlack/images/ui-icons_454545_256x240.png');
        }
    </style>
...
<div class="fui-layout" style="width:100%;height:100%;">
    ...
    <div showHeader="false" region="south" class="foot" height="39px" style="border:1px;text-align:center;" showSplit="false">
