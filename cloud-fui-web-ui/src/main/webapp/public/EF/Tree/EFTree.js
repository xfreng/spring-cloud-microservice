...
var EFTreeConfig = {
    ...
    iIcon: efico.get("eftree.treeImgI"),
    lIcon: efico.get("eftree.treeImgL"),
    lMinusIcon: efico.get("eftree.treeImgLminus"),
    lPlusIcon: efico.get("eftree.treeImgLplus"),
    tIcon: efico.get("eftree.treeImgT"),
    tMinusIcon: efico.get("eftree.treeImgTminus"),
    tPlusIcon: efico.get("eftree.treeImgTplus"),
...
**/
function EFTree(sModel, sLabel, sText) {
    ...
    this._rootNode = new EFTreeNode(this, null, null, this._text, false, null);
...
//        var subItems = this._rootNode._childNodes;
...
//    var iframe = $("#" + menu.id).find("iframe").get(0);
...
//    iframe.style.height = menu.offsetHeight;
    ...
    if (redge < menu.offsetWidth) {
        menu.style.left = (document.body.scrollLeft + event.clientX - menu.offsetWidth)+"px";
    }
    else {
    ...
    if (bedge < menu.offsetHeight) {
        menu.style.top = (document.body.scrollTop + event.clientY - menu.offsetHeight)+"px";
    }
    else {
...
EFTreeNode.prototype._renderSkeleton = function () {
    var tree = this.tree();
    if (this._jTreeNodeDIV == null) {
        ...
        this._jNodeTextDiv.innerHTML = " " + this._text + "<br/>";
        ...
        var instance = this;
        this._jNodeArchDiv.onclick = function () { instance.onArchClicked(); };
        if (this._active) {
            this._jNodeTextDiv.onclick = function () { instance.onTextClicked(); };
        }
        this._jNodeImgDiv.onclick = function () { instance.onImageClicked(); };
 ...
 * @class EFTreeNode类
 */
EFTreeNode.prototype.render = function () {
