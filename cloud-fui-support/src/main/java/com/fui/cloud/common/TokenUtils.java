...
public class TokenUtils {
     ...
     * @return
     */
    public ManageToken toManageToken(JSONObject user) throws IOException {
        Long userId = user.getLong("id");
        String passwordVersion = user.getString("password");
    ...
    public JSONObject checkManageToken(ManageToken manageToken) {
        ...
        if (manageToken.getUser() != null) {
            userId = manageToken.getUser().getString("id");
        }
